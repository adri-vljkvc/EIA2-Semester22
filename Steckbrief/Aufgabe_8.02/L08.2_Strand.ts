namespace L08_2_StrandCanvas {
    ...
    function handleLoad(): void {
        ...
        let context: CanvasRenderingContext2D = document.querySelector("canvas").getContext("2d");
        var render = function() {
    ...
    function Clouds(crc2): void {

        crc2.save();
        let scale: number = ((crc2.canvas.width * 0.7) / 1000);
    ...
    function People(crc2) {
        ...
        crc2.save();
        let scale: number = ((crc2.canvas.width * 1) / 1000);
